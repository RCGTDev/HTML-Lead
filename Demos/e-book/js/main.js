...
$(document).ready(function () {
     ...
     $('.tz_submit').on('click', function (event) {
        ...
        if (tz_process)
        {
            $.post("tz_mail/contact.php", {
                ...
                if (tz_form_output != '')
                {
                    if($('form').closest("section").attr('id') !== undefined)
                    {
                        var section_id = $('form').closest("section").attr('id');
                    }else{
                        var section_id = $('form').closest("footer").attr('id');
                    }
   ...
   $('.default-submit').on('click', function (event) {
        ...
        if(tz_process) 
        {
            ...
            $.post("tz_mail/ebook-contact.php", {
   ...
   $('.subscribe-submit').on('click', function (event) {
        ...
        {
            localStorage.setItem('tz_section',section_id);
            $.post("tz_mail/subscribe-contact.php", {
                data: { email: email},
                type: "POST",
            }, function (data) {
                $('#loading').remove();
